...
export const createSceneTool: Tool = {
  ...
  description:
    ...
    "Visual layers can include deformation: { kind: 'bend', enabled, angle, factor, showOriginalGeometry, bothDirections, limitToRegion, captureDirection: { x, y, z }, captureRotation, upDirection: { x, y, z }, upRotation, bendRotation, captureOrigin: { x, y, z }, captureLength, surfaceShading, depthAware, lightAzimuth, lightElevation, ambient, diffuse, specular, roughness, geometryDetail }. Use upDirection { x: 0, y: 0, z: 1 } for a true out-of-canvas 3D fold and { x: 0, y: 1, z: 0 } for a flat canvas bend. Angle is -360..360 degrees, factor and roughness are 0..1, light elevation is -90..90, light levels are 0..2, captureLength 0 auto-fits the layer, and geometryDetail is 4..128. Bend angle, factor, directions, rotations, origin, capture length, and surface-light values can be keyframed with deformation.bend.* property IDs.\n" +
